//! Typvia mobile FFI surface: the UniFFI layer the Swift keyboard extension
//! and Kotlin IME call into. The snapshot *file* stays the main
//! data channel; this crate only gives extensions a typed way to read it,
//! so the exported surface stays small and stable.
//!
//! Dependency direction: mobile-ffi → core. No platform types cross into
//! core/crypto — that crate boundary is fixed.
